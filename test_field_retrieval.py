...
args.decoder ='./experiments/%s/%s_field_retrieval/decoder_iter_50000.pth.tar'%(args.data_name, args.exp_name)
args.decoder_ph ='./experiments/%s/%s_field_retrieval/decoder_ph_iter_50000.pth.tar'%(args.data_name, args.exp_name)
