...
# training options
parser.add_argument('--save_dir', default='./output/new_dataset_241122_singlestyle',
...
for i in range(100):
    if args.data_name == 'MNIST':
        ...
        style_holo = torch.load(f"/mnt/mooo/fakhriyya/new_code/style_transfer_based_holographic_imaging/new_dataset_241122/test_style_holo_{i}.pt")
    ...
    for j in range(args.batch_size):
        ...
        with torch.no_grad():
            ...
            distance_per_psnr[round(distance_content.squeeze()[j].item(), 3)] = psnr_list[-1]
            distance_per_mae[round(distance_content.squeeze()[j].item(), 3)] = mae_list[-1]
